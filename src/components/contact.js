                ...
                <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                        ...
                        <ul class="mt-12 space-y-8">
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-white text-sm ml-3">
                                    <strong>jacksondoumith006@gmail.com</strong>
                                </a>
                            </li>
                            <li class="flex items-center">
                    ...
                    <div class="bg-gray-200 p-6 rounded-lg">
                        ...
                        <form class="mt-8 space-y-4">
                            ...
                            <button type='button'
                                class="text-white  bg-blue-500 hover:bg-[#a91079e2] font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full">
